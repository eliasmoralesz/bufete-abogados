...
import logo from '../assets/Daguer Hernandez Abogado nombre dorado.webp';
import './Footer.css';
        ...
        <div className="footer-write">
          ...
          <div className="email-social-wrapper">
            ...
            <div className="social-icons">
              ...
              >
                <svg width="24" height="24" viewBox="0 0 256 256" fill="none" stroke="#d4af37" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
