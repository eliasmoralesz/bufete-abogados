...
import logo from '../assets/Daguer Hernandez Abogado nombre blanco.webp';
import './Footer.css';
        ...
        <div className="footer-write">
          ...
          <div className="email-social-wrapper">
            ...
            <div className="social-icons">
              <a
                href="https://www.instagram.com/daguerhernandezcr/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label={t('socialInstagram')}
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#F0EDE6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              ...
              <a
                href="https://www.tiktok.com/@daguerhernandezcr"
                target="_blank"
                rel="noopener noreferrer"
                className="tiktok-icon"
                aria-label={t('socialTiktok')}
              >
                <svg width="24" height="24" viewBox="0 0 256 256" fill="none" stroke="#F0EDE6" strokeWidth="16" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <a
                href="https://www.facebook.com/dauberth"
                target="_blank"
                rel="noopener noreferrer"
