        ...
        <div className="footer-write">
          ...
          <div className="email-social-wrapper">
            ...
            <div className="social-icons">
              ...
              <a href="https://www.tiktok.com/@daguerhernandezcr" target="_blank" rel="noopener noreferrer" className="tiktok-icon">
              ...
              <a href="https://www.facebook.com/dauberth" target="_blank" rel="noopener noreferrer">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#d4af37" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
